                    ...
                    >
                        <span className="relative inline-flex items-center justify-center w-7 h-7">
                            ...
                            <motion.span
                                ...
                                animate={{ scale: [0.7, 1.6, 0.7], opacity: [0.6, 0.08, 0.6] }}
                                transition={{ duration: 2.2, repeat: Infinity, ease: "easeInOut" }}
                            />

                            <motion.span
                                aria-hidden
                                className="absolute inline-block w-8 h-8 rounded-full bg-green-500/40 blur-2xl"
                                initial={{ scale: 0.9, opacity: 0.8 }}
                                animate={{ scale: [0.9, 1.25, 0.9], opacity: [0.8, 0.25, 0.8] }}
                            ...
                            <motion.span
                                ...
                                animate={{ scale: [0.9, 1.35, 1.0], opacity: [0, 0.7, 0] }}
                            ...
                            <motion.span
                                ...
                                animate={{ scale: [1, 1.4, 1], opacity: [0.9, 0.25, 0.9] }}
                            ...
                            <motion.span
                                ...
                                aria-hidden={false}
                            >
                                <Circle className="h-2 w-2 fill-green-500/90" />
                            </motion.span>
                        </span>
